...
[PR](https://github.com/nitrojs/nitro/pull/3350)

This repository have the mission to try to test the diferent options with `aws-amplify` preset and AWS Amplify environment.
